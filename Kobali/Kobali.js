...
function handleClick(page) {
    ...
    if (page === 'sonic1') {
        if (clickCounts.sonic1 === 1) {
            ...
            window.open('Kobali1.html', '_blank');
    ...
    if (page === 'sonic2') {
        if (clickCounts.sonic2 === 1) {
            ...
            window.open('Kobali2.html', '_blank');
    ...
    if (page === 'sonic3') {
        if (clickCounts.sonic3 === 1) {
            ...
            window.open('Kobali3.html', '_blank');
    ...
    if (page === 'sonic4') {
        if (clickCounts.sonic4 === 1) {
            ...
            window.open('Kobali4.html', '_blank');
    ...
    if (page === 'sonic5') {
        if (clickCounts.sonic5 === 1) {
            ...
            window.open('Kobali5.html', '_blank');
    ...
    if (page === 'sonic6') {
        if (clickCounts.sonic6 === 1) {
            ...
            window.open('Kobali6.html', '_blank');
    ...
    if (page === 'sonic7') {
        if (clickCounts.sonic7 === 1) {
            ...
            window.open('Kobali7.html', '_blank');
    ...
    if (page === 'sonic8') {
        if (clickCounts.sonic8 === 1) {
            ...
            window.open('Kobali8.html', '_blank');
