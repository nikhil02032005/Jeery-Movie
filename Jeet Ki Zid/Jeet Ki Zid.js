...
function handleClick(page) {
    ...
    if (page === 'sonic1') {
        if (clickCounts.sonic1 === 1) {
            ...
            window.open('Jeet Ki Zid1.html', '_blank');
    ...
    if (page === 'sonic2') {
        if (clickCounts.sonic2 === 1) {
            ...
            window.open('Jeet Ki Zid2.html', '_blank');
    ...
    if (page === 'sonic3') {
        if (clickCounts.sonic3 === 1) {
            ...
            window.open('Jeet Ki Zid3.html', '_blank');
    ...
    if (page === 'sonic4') {
        if (clickCounts.sonic4 === 1) {
            ...
            window.open('Jeet Ki Zid7.html', '_blank');
    ...
    if (page === 'sonic5') {
        if (clickCounts.sonic5 === 1) {
            ...
            window.open('Jeet Ki Zid8.html', '_blank');
    ...
    if (page === 'sonic6') {
        if (clickCounts.sonic6 === 1) {
            ...
            window.open('Jeet Ki Zid9.html', '_blank');
    ...
    if (page === 'sonic7') {
        if (clickCounts.sonic7 === 1) {
            ...
            window.open('Jeet Ki Zid10.html', '_blank');
